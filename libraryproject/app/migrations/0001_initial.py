    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Guardian_name', models.CharField(help_text='parent/guardian full name', max_length=100)),
                ('Email', models.EmailField(help_text='Guardian/parent e-mail', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateTimeField(default=datetime.datetime(2022, 12, 6, 16, 48, 0, 978064), help_text='Date the book is due to')),
                ...
                ('book_instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.bookinstance')),
